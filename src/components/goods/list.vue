			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr v-for="gm in goodsList" v-bind:key="gm.goodsId">
						...
						<td>{{gm.brand}}</td>
						<td>
							<router-link v-bind:to="'modify/'+gm.goodsId" class="btn btn-default">修改</router-link>

							<a href="#" v-on:click="deleteGoods(gm.goodsId)" class="btn btn-danger">删除</a>
							<router-link v-bind:to="'view/'+gm.goodsId" class="btn btn-default">查看</router-link>
						</td>
					</tr>
